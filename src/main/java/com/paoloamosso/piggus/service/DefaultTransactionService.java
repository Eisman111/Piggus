...
public class DefaultTransactionService implements TransactionService{
    ...
    @Override
    public TransactionRequest buildTransactionRequest(Transaction transaction) {

        return null;
    }

    public void archiveTransaction(Transaction defaultExpense) {
        defaultExpense.setIsArchived(true);
        transactionRepository.save(defaultExpense);
    }

    public void removeTransaction(Transaction defaultExpense) {
